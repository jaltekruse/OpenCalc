...
public class SelectionPanel extends SubPanel {
	...
	public SelectionPanel(MainApplet mainApplet, TopLevelContainer topLevelComp, GraphWindow gw) {
		super(topLevelComp);
		...
		startField = new OCTextField(topLevelComp, true, 10, 1, 1, 1, 1, this, mainApp){
			...
			public void associatedAction(){
				try{
					...
					Value temp = mainApp.getParser().ParseExpression(getField().getText());
